            ...
            <div className="h-24 w-24 bg-center bg-no-repeat mb-10 -mt-40 absolute" style={{ backgroundImage: `url(${logo.src})` }} />
              ...
              <>
                <Link href="/eventManagementForm">
                  <button className="h-12 mt-10 w-40 py-2 px-4 bg-white text-[#423D38] rounded-full flex items-center justify-center mb-10 text-xs font-geistMono hover:bg-[#ACB7BC]">
                      Manage Events
                  </button>
                </Link>
